...
## Result:
Thus the program was executed and the output was verified successfully.# EX 59 C functions to perform-enqueue, dequeue, peek, display in Queue using Linked List.(use float data in Queue).
## DATE:5/5/25
## AIM:
